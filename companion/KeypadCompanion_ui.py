...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.buttonBox.setGeometry(QRect(10, 550, 771, 41))
        ...
        self.keypadMode.setGeometry(QRect(565, 30, 125, 21))
        self.label_mapMode = QLabel(Dialog)
        self.label_mapMode.setObjectName(u"label_mapMode")
        self.label_mapMode.setGeometry(QRect(425, 22, 141, 36))
        self.label_device = QLabel(Dialog)
        self.label_device.setObjectName(u"label_device")
        self.label_device.setGeometry(QRect(105, 22, 51, 36))
        self.device = QComboBox(Dialog)
        self.device.setObjectName(u"device")
        self.device.setGeometry(QRect(155, 30, 125, 21))
        self.gridLayoutWidget = QWidget(Dialog)
        self.gridLayoutWidget.setObjectName(u"gridLayoutWidget")
        self.gridLayoutWidget.setGeometry(QRect(130, 200, 531, 331))
        ...
        self.skyLogo.setGeometry(QRect(0, 0, 121, 111))
        ...
        self.validLabel.setGeometry(QRect(315, 22, 100, 36))
        ...
        self.noDevice.setGeometry(QRect(315, 22, 100, 36))
        ...
        self.deviceRefresh.setGeometry(QRect(280, 30, 21, 21))
        icon1 = QIcon()
        icon1.addFile(u":/icons/assets/view-refresh.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.deviceRefresh.setIcon(icon1)
        self.rotMIDI = QComboBox(Dialog)
        self.rotMIDI.setObjectName(u"rotMIDI")
        self.rotMIDI.setEnabled(False)
        self.rotMIDI.setGeometry(QRect(190, 100, 125, 21))
        self.rotFuncMIDIlabel = QLabel(Dialog)
        self.rotFuncMIDIlabel.setObjectName(u"rotFuncMIDIlabel")
        self.rotFuncMIDIlabel.setGeometry(QRect(60, 92, 131, 36))
        self.rotFuncMIDIlabel_held = QLabel(Dialog)
        self.rotFuncMIDIlabel_held.setObjectName(u"rotFuncMIDIlabel_held")
        self.rotFuncMIDIlabel_held.setGeometry(QRect(30, 122, 161, 36))
        self.rotMIDI_held = QComboBox(Dialog)
        self.rotMIDI_held.setObjectName(u"rotMIDI_held")
        self.rotMIDI_held.setEnabled(False)
        self.rotMIDI_held.setGeometry(QRect(190, 130, 125, 21))
        self.rotFuncMIDIlabel_button = QLabel(Dialog)
        self.rotFuncMIDIlabel_button.setObjectName(u"rotFuncMIDIlabel_button")
        self.rotFuncMIDIlabel_button.setGeometry(QRect(70, 152, 121, 36))
        self.rotMIDI_sw = QComboBox(Dialog)
        self.rotMIDI_sw.setObjectName(u"rotMIDI_sw")
        self.rotMIDI_sw.setEnabled(False)
        self.rotMIDI_sw.setGeometry(QRect(190, 160, 125, 21))
        self.rotFunKeylabel_button = QLabel(Dialog)
        self.rotFunKeylabel_button.setObjectName(u"rotFunKeylabel_button")
        self.rotFunKeylabel_button.setGeometry(QRect(420, 152, 141, 36))
        self.rotKey_held = QComboBox(Dialog)
        self.rotKey_held.setObjectName(u"rotKey_held")
        self.rotKey_held.setEnabled(False)
        self.rotKey_held.setGeometry(QRect(560, 130, 125, 21))
        self.rotFunKeylabel = QLabel(Dialog)
        self.rotFunKeylabel.setObjectName(u"rotFunKeylabel")
        self.rotFunKeylabel.setGeometry(QRect(400, 92, 151, 36))
        self.rotKey_sw = QComboBox(Dialog)
        self.rotKey_sw.setObjectName(u"rotKey_sw")
        self.rotKey_sw.setEnabled(False)
        self.rotKey_sw.setGeometry(QRect(560, 160, 125, 21))
        self.rotKey = QComboBox(Dialog)
        self.rotKey.setObjectName(u"rotKey")
        self.rotKey.setEnabled(False)
        self.rotKey.setGeometry(QRect(560, 100, 125, 21))
        self.rotFunKeylabel_held = QLabel(Dialog)
        self.rotFunKeylabel_held.setObjectName(u"rotFunKeylabel_held")
        self.rotFunKeylabel_held.setGeometry(QRect(370, 122, 191, 36))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.rotFuncMIDIlabel.setText(QCoreApplication.translate("Dialog", u"MIDI Rotary encoder:", None))
        self.rotFuncMIDIlabel_held.setText(QCoreApplication.translate("Dialog", u"MIDI Rotary encoder (held):", None))
        self.rotFuncMIDIlabel_button.setText(QCoreApplication.translate("Dialog", u"MIDI button action:", None))
        self.rotFunKeylabel_button.setText(QCoreApplication.translate("Dialog", u"Keyboard button action:", None))
        self.rotFunKeylabel.setText(QCoreApplication.translate("Dialog", u"Keyboard Rotary encoder:", None))
        self.rotFunKeylabel_held.setText(QCoreApplication.translate("Dialog", u"Keyboard Rotary encoder (held):", None))
    # retranslateUi
